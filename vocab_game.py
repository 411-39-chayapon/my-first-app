...
def show_result_dialog(ans1, ans2, ans3, ans4):
    ...
    # ✅ จุดที่ 3: สรุปผลการเล่นเกมใน MessageBox (u_ans3, u_ans4)
...
ans4 = st.text_input(
    "ข้อ 4: Before the exam, don't forget your `p _ n c i l`. ✏️",
...
# ✅ จุดที่ 7: เพิ่มการอัปเดตค่าล่าสุดเข้าตัวแปร ans3_val และ ans4_val
...
st.divider()
st.write("นายชยพล พรชนะภากร ม.4/11 เลขที่39")
